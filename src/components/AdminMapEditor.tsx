      ...
      <div className="bg-white border-b border-stone-200 p-4 sm:p-6 flex flex-col sm:flex-row items-center justify-between gap-4 shadow-sm z-20 shrink-0">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className={clsx(
              "flex items-center px-6 py-3 rounded-xl font-bold transition-all shadow-sm border-2", 
              hasUnsavedMapChanges ? "bg-emerald-600 text-white border-emerald-500 hover:bg-emerald-700 animate-pulse" : "bg-stone-100 text-stone-400 border-stone-200 cursor-not-allowed"
            )}
          >
            <Save className="w-5 h-5 mr-2" />
            {hasUnsavedMapChanges ? "Save Map Positions" : "Map is Saved"}
          </button>
        </div>
      </div>
