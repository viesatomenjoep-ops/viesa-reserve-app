  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-8 flex justify-between items-end">
        <div>
          <h1 className="text-3xl font-bold text-slate-900">Yield Management</h1>
          <p className="text-slate-500">Dynamic Pricing op basis van de weersverwachting API.</p>
        </div>
        <div className="bg-indigo-50 text-indigo-700 px-4 py-2 rounded-xl font-medium flex items-center gap-2 border border-indigo-100">
          <Settings className="w-4 h-4" /> Autopilot Ingeschakeld
        </div>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center shadow-sm">
          <div className="flex items-center gap-4 w-full md:w-1/3">
            ...
            <div>
              <p className="font-bold text-slate-900">Zonnig & Warm</p>
              <p className="text-sm text-slate-500">{'>'} 25°C, Kans op regen {'<'} 10%</p>
            </div>
          </div>
          ...
          <div className="flex-1 w-full bg-slate-50 rounded-xl p-4 border border-slate-100">
            <p className="font-semibold text-slate-700 mb-2">Actie:</p>
            <div className="flex gap-4">
              <div className="bg-white border border-slate-200 px-4 py-2 rounded-lg flex-1 text-center">
                <span className="block text-xs text-slate-500">Basisbed Prijs</span>
                <span className="font-bold text-green-600">+ 20%</span>
              </div>
              <div className="bg-white border border-slate-200 px-4 py-2 rounded-lg flex-1 text-center">
                <span className="block text-xs text-slate-500">VIP Cabana</span>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 flex flex-col md:flex-row gap-6 items-center shadow-sm">
          <div className="flex items-center gap-4 w-full md:w-1/3">
            ...
            <div>
              <p className="font-bold text-slate-900">Bewolkt / Regen</p>
              <p className="text-sm text-slate-500">{'<'} 20°C of Regen</p>
            </div>
          </div>
          <ArrowRight className="w-6 h-6 text-slate-300 hidden md:block" />
          <div className="flex-1 w-full bg-slate-50 rounded-xl p-4 border border-slate-100">
            ...
            <div className="flex gap-4">
              ...
              <div className="bg-white border border-slate-200 px-4 py-2 rounded-lg flex-1 text-center">
                <span className="block text-xs text-slate-500">VIP Cabana</span>
                <span className="font-bold text-slate-500">Geen wijziging</span>
              </div>
            </div>
          </div>
        </div>
